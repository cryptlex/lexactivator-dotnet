...
namespace Cryptlex
{
    static class LexActivatorNative
    {
        ...
        [DllImport(DLL_FILE_NAME, CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Cdecl)]
        public static extern int CheckReleaseUpdate(LexActivator.ReleaseCallbackType releaseCallback, LexActivator.ReleaseFlags releaseFlags);

        [DllImport(DLL_FILE_NAME, CharSet = CharSet.Ansi, EntryPoint = "CheckReleaseUpdate", CallingConvention = CallingConvention.Cdecl)]
        public static extern int CheckReleaseUpdateA(LexActivator.ReleaseCallbackType releaseCallback, LexActivator.ReleaseFlags releaseFlags);
        ...
        [DllImport(DLL_FILE_NAME_X86, CharSet = CharSet.Unicode, EntryPoint = "CheckReleaseUpdate", CallingConvention = CallingConvention.Cdecl)]
        public static extern int CheckReleaseUpdate_x86(LexActivator.ReleaseCallbackType releaseCallback, LexActivator.ReleaseFlags releaseFlags);

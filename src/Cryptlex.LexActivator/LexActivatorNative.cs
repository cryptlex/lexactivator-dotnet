...
namespace Cryptlex
{
    static class LexActivatorNative
    {
        ...
        public static extern int CheckReleaseUpdateInternalA(LexActivator.InternalReleaseCallbackType internalReleaseCallback, LexActivator.ReleaseFlags releaseFlags, IntPtr _userData);
